...
work_dir="$(mktemp -d "${TMPDIR:-/tmp}/brain-plugin-hello-published-smoke.XXXXXX")"
...
{
  "name": "brain-hello-instance-published-smoke",
  "private": true,
  "type": "module",
  "dependencies": {
...
printf 'External hello plugin published-package smoke proof passed.\n'
